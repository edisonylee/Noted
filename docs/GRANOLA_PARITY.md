...
- Production frontend compilation, service typechecking and all 335 active Rust unit tests pass (three manual/live tests remain ignored). The service suite includes restart persistence, read-only integration scopes and MCP through a real HTTP listener.
