      ...
      <div className="modal phone-pairing-modal" onClick={(event) => event.stopPropagation()}>
        ...
        {info?.pendingConfirmation ? (
          <section className="phone-confirmation">
            ...
            <small>Access: notes, folders, and categories on this Mac</small>
          ...
          <>
            <p className="muted">Keep Noted open on both devices and use the same Wi-Fi. Pairing is end-to-end authenticated and your Mac remains the source of truth.</p>
